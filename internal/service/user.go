...
type UserService interface {
	...
	Login(req *ginmodel.UserNameLoginReq) (*ginmodel.LoginResponse, error)
}
...
func (s *userService) Login(req *ginmodel.UserNameLoginReq) (*ginmodel.LoginResponse, error) {
	...
	accessToken, err := middlerware.GenerateToken(user.ID)
	if err != nil {
		return nil, errors.New("系统错误")
	}

	return &ginmodel.LoginResponse{
